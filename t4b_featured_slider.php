...
function t4b_admin_enqueue_scripts() {
	...
	wp_enqueue_style('t4b-admin-css', WP_PLUGIN_URL .'/t4b-featured-slider/css/t4b-admin.css?v=1.0');
}
...
.slimg{
	float:left;
	margin:<?php $t4b_slider_image_top = get_option('image_top'); if(!empty($t4b_slider_image_top)) {echo $t4b_slider_image_top;} else {echo "25";}?>px 20px 10px 20px;
...
.mytext-right span{
	padding:5px;
	background:<?php $t4b_slider_pinfo_color = get_option('pinfo_color'); if(!empty($t4b_slider_pinfo_color)) {echo $t4b_slider_pinfo_color;} else {echo "#4C666C";}?>;
	color:<?php $t4b_slider_pintxt_color = get_option('pintxt_color'); if(!empty($t4b_slider_pintxt_color)) {echo $t4b_slider_pintxt_color;} else {echo "#FAFAFA";}?>;
	font-size: 12px ;
}
.bx-wrapper{
