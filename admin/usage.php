<div class="wrap">
	...
	<div style="width: 65%; float: left;">
		<div class="postbox" style="display: block;float:left;margin:5px;clear:left; width: 99%;">
			...
			<div class="inside"><p align="justify">"T4B Featured Slider" is a simple and easy WordPress plugin to show featured posts on your blog using a smooth jQuery slider. You can use this plugin as an alternate of WordPress <strong>Sticky</strong> posts.<br /><br />At first, you have to add the ID of a post, which you wish to see in the featured lists. To get the ID of a post simply enter the URL of the post in the given text field at the <strong>Featured</strong> page and click on <strong>Get ID</strong> button. It will show you the ID of the post. Just enter the ID into the second text field where the <strong>Add Post</strong> button exists and click on that button. If nothing goes wrong you will get a confirmation message that you have successfully inserted the post in the featured lists. You can also remove a featured post from the list. In the table of featured post lists you will get a <strong>Delete</strong> button beside each of the post list. Now, to remove a featured post, simply click on the <strong>Delete</strong> button that exists on that post row.<br /><br />At the end, to show the featured slider, just enable the <strong>Show Featured Slider</strong> option located at the top of the <strong>Settings</strong> page, where you can also customize the Featured Slider from <strong>T4B Featured Slider Configuration</strong> by changing the options. You don't have to edit the Stylesheet, you can make changes directly in your Administration Panel (Settings >> T4B Featured Slider Configuration).<br /><br />Finally, copy the below code and paste in your blog posts/pages, where you want to show the featured slider.</p></div>
		</div>
