				...
				<div><p align="justify">To get the ID of a post simply enter the URL of the post and then click on Get ID button:</p>
   					<table class="form-table">
       					<tr valign="top">
       						...
       						<td><input type="text" name="post_link" value="" size="60" /><input type="submit" name="get_id" class="button-primary" value="Get ID"></td>
       					</tr>
				...
				<div><p align="justify">To make a post as featured simply enter the post ID and click on Add ID button.</p>
	   				<table class="form-table">
       					<tr valign="top">
    	    				...
    	    				<td><input type="text" name="postID" size="10" value="" /><input type="submit" name="list_id" class="button-primary" value="Add Post" /></td>
   	   					</tr>
		    		</table>
				</div>
			</div>
